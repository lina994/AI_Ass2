...
public class GameSemiCooperativeAgent extends GameAgent {
    ...
    Comparator<StateNode> semiStateNodeComparatorMinToMax = new Comparator<StateNode>() {
        ...
        public int compare(StateNode o1, StateNode o2) {
            ...
            if (o2.heuristic > o1.heuristic)
                return -1;
            if (o2.oppHeuristic < o1.oppHeuristic)
                return 1;
            if (o2.oppHeuristic > o1.oppHeuristic)
                return -1;
            return 0;
    ...
    void updateParentsScore(StateNode parent, StateNode child) {
        ...
        if (parent.depth % 2 == 0) { // agent
            if (child.agentScore > parent.agentScore
                    || (child.agentScore == parent.agentScore && child.opponentScore > parent.opponentScore)
                    || parent.next == null) {
            ...
            if (child.opponentScore > parent.opponentScore
                    || (child.opponentScore == parent.opponentScore && child.agentScore > parent.agentScore)
                    || parent.next == null) {
                parent.agentScore = child.agentScore;
                parent.opponentScore = child.opponentScore;
                parent.next = child;
